package com.example.jari.search;
...
import com.example.jari.home.HomeMenuAdapter;
import com.example.jari.home.HomeMenuItem;
...
public class Frag_search extends Fragment {
    ...
    public static Frag_search newInstance(String query) {
    ...
    public void getService() {
        ...
        retrofitService.getStoreSearch(mQuery).enqueue(new Callback<Result>() {
            @Override
            public void onResponse(Call<Result> call, Response<Result> response) {
                if (response.isSuccessful()) {
                    Result result = response.body();
                    List<Store> storeList = result.getStoreSearch();
                    getData(storeList);
                }
            }
