...
public class Frag_home_menu_ch extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull final ViewGroup container,
        ...
        view = (View) inflater.inflate(R.layout.frag_home_menu_ch, container, false);
    ...
    private void getData(List<Store> retrofitList) {
        ...
        List<Integer> listIcon = Arrays.asList(
                ...
                R.drawable.storech02,
                R.drawable.storech03,
                R.drawable.storech04,
                R.drawable.storech05);
