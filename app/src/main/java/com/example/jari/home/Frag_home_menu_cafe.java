...
public class Frag_home_menu_cafe extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @NonNull final ViewGroup container,
        ...
        view = (View) inflater.inflate(R.layout.frag_home_menu_cafe, container, false);
    ...
    private void getData(List<Store> retrofitList) {
        ...
        List<Integer> listIcon = Arrays.asList(
                R.drawable.storecafe01,
                R.drawable.storecafe02,
                R.drawable.storecafe03,
                R.drawable.storecafe04,
                R.drawable.storecafe05);
